	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="category_button1">		
					<button type="button" id="button3" class="form-control" style="width: 338px; height: 57px; background-image: url('test/shingo1.png');">
						<span class="number" style="font-size: 26pt; font-weight: bold; color:blue; margin-left: 240px;">4</span>
					</button>				
					<div id="space1"></div>
					<button type="button" id="button4" class="form-control" style="width: 338px; height: 57px; background-image: url('test/shingo2.png');">
						<span class="number" style="font-size: 26pt; font-weight: bold; color:blue; margin-left: 240px;">5</span>
					</button>
			</div>
