...
<head>
<meta charset="UTF-8">
<title>내담당 문의/신고 - 전체 신고 목록.jsp</title>
<style type="text/css">
	...
	<div class="row">
		...
		<div class="col-md-8 ">
			<div class="category_button">		
					...
					<button type="button" id="button4" class="form-control" style="width: 215px; height: 100px; background-image: url('test/Test7.png');">
						<span class="number" style="font-size: 26pt; font-weight: bold; color:violet; margin-left: 100px;">5</span>
					</button>
			</div>
		</div>
		<div class="col-md-2">
		...
		<div class="col-md-8">		
			<ul class="list-group post">
					...
					<li class="list-group-item post_board">
						...
						<div class="col-md-2">
							<span class="board-header">[ <span style="color: violet; font-weight: bold;">반려</span> ]</span>
						</div>
					</li>
					<li class="list-group-item post_board">
						<div class="col-md-1">
