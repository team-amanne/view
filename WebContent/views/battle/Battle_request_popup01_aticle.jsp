...
<div class="col-md-6">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="col-md-12">
					<div class="col-md-4">
						<p class="subtitle-text">상대 크루 전적 |</p>
					</div>
					<div class="col-md-8">
						<p><span class="text-orange">n</span>전 &nbsp; <span class="text-orange">n</span>승 &nbsp;<span class="text-orange">n</span>무 &nbsp; <span class="text-orange">n</span>패 &nbsp;<span class="text-orange">n</span>무효 </p>
						<p class="text-orange">승률&nbsp; <span>n%</span></p>
					</div>
				</div>
	...
	<div class="col-md-3">
		...
		<div class="col-md-3">
			<button class="btn btn-defualt btn-block">
			닫 기
			</button>
		</div>
	<div class="col-md-3">
