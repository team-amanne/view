				...
				<div class="col-md-8">
					...
					<div class="row">
						<div class="col-sm-4 col-xs-5 left-btn">
							<a href="Userinfo.jsp"><button type="button" class="btn btn-default">내 정보관리</button></a>
						...
						<div class="col-sm-4 col-xs-5 right-btn">
							...
							<a href="UserBlock.jsp"><button type="button" class="btn btn-default btn-link">차단 관리</button></a>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-4 col-xs-6" style="position: relative; left:10px; top: -10px; z-index: 2; text-align: center;">
							<button type="button" class="btn btn-default btn-submit">프로필 변경</button>
						</div>					
						<div class="col-md-4 col-xs-3">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-2 col-xs-2">
							<button type="button" class="btn btn-default btn-submit btn-block">자기소개글 등록</button>
						</div>
						<div class="col-sm-2 col-xs-2">
						</div>
						<div class="col-sm-2 col-xs-2">
