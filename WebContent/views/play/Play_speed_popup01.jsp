						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-8">
									...
									<div class="col-md-8">
										<h5>서울시 마포구 쌍용코트 <button class="btn btn-xs">위치 보기</button></h5>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<div class="col-md-6">
								<button type="button" class="btn btn-default btn-lg btn-block">참가</button>
								</div>
								<div class="col-md-6">
								<button type="button" class="btn btn-default btn-lg btn-block">불참</button>
								</div>
							</div>
							<div class="col-md-2"></div>
						</div>
