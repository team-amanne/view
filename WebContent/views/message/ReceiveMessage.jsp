					...
					<div class="col-md-8">
						...
						<div class="row">
							<div class="col-md-5 col-sm-8 col-xs-8 left-btn">
								<a href="ReceiveMessageList.jsp">
									<button class="btn btn-default" type="submit">수신메시지함</button>
								</a> <a href="#">
									<button class="btn btn-default" type="submit">답장하기</button>
								</a>
							</div>
						...
						<ul class="list-group">
							...
							<li class="list-group-item msg-person">
								...
								<div class="col-md-2 col-sm-2 col-xs-3">
									<span class="board-header">받는 사람</span>
								</div>
								<div class="col-md-1 col-sm-1 col-xs-1">
									<span> | </span>
								</div>
							...
							<li class="list-group-item msg-content">
								<div class="col-md-12">
									<span>안녕하세요</span> <span>저는 동규라고 합니다.</span>
								</div>
							</li>
						</ul>
					</div>
